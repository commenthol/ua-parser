...
class FetcherTest extends AbstractTestCase
{
    ...
    public function testFetchError()
    {
        ...
        $this->setExpectedException(
            'UAParser\Exception\FetcherException',
            'Could not fetch HTTP resource "https://raw.github.com/commenthol/ua-parser/master/regexes.yaml": file_get_contents(https://raw.github.com/commenthol/ua-parser/master/regexes.yaml): failed to open stream: operation failed'
        );
